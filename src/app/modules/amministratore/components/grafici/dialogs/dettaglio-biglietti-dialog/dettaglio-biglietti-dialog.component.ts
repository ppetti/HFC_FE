...
@Component({
  selector: 'app-dettaglio-biglietti-dialog',
  templateUrl: './dettaglio-biglietti-dialog.component.html',
  styleUrls: ['./dettaglio-biglietti-dialog.component.scss']
})
export class DettaglioBigliettiDialogComponent implements OnInit {

  // bigliettiVendutiPerTipo = [ {nomeTipologia: "72 HRS OPEN BUS", nomeMacrosettore: "Macro 40", numeroBigliettiVenduti: 0 },
  // {nomeTipologia: "24 HRS OPEN BUS", nomeMacrosettore: "Macro 40", numeroBigliettiVenduti: 0 }, {nomeTipologia: "48 HRS OPEN BUS", nomeMacrosettore: "Macro 40", numeroBigliettiVenduti: 0 }]
  ...
  ngOnInit(): void {
    this.loader.show();
    this.amministratoreService.getAllTipologieBigliettoDimensionaleNoTours().subscribe(
      tipologieList => {
  ...
  submit() {
    ...
    this.amministratoreService.getBigliettiVendutiPerTipologiaFiltratiNoTours(wrapper).subscribe(
      responseTipologie => {
